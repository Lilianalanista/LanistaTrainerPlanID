    ...
    onPlanExercisesListAfterRender: function(component, eOpts) {
            ...
            el.on(
                'click', function(e,t) {
                    ...
                    exerciseStore.filter ({property :'id', value: itemRecord.exercise_id !== 0 ? itemRecord.exercise_id : itemRecord.user_exercise_id});
                    exerciseStore.load(function(records, operation, success) {
                        if (success) {
                            LanistaTrainer.app.getController('PlanController').getPlanPanel().addCls ('blured');
                            LanistaTrainer.app.fireEvent('showExercisePanel', records[0], itemRecord);
                        }
                    });
                },
