    ...
    items: [
        {
            ...
            tpl: [
                ...
                '        <div id="image-start-position" class="exercise-image" style="-webkit-background-size: cover; background-image: url({[(values.ext_id && values.ext_id.indexOf(\'CUST\') != -1) ? (Ext.ux.ConfigManager.getServer() + Ext.ux.ConfigManager.getRoot() + \'/tpmanager/img/b/\'+values.ext_id) : \'resources/images/previews/\'+values.ext_id]}_2.jpg);\'"></div>',
                '        <div id="image-start-position" class="exercise-image" style="-webkit-background-size: cover; background-image: url({[(values.ext_id && values.ext_id.indexOf(\'CUST\') != -1) ? (Ext.ux.ConfigManager.getServer() + Ext.ux.ConfigManager.getRoot() + \'/tpmanager/img/b/\'+values.ext_id) : \'resources/images/previews/\'+values.ext_id]}_1.jpg);\'"></div>',
                '    </div>',
                '</div>'
            ]
        },
